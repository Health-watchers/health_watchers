...
import { advancedRateLimiting, SubscriptionTier } from '../../services/advanced-rate-limiting.service';
...
router.get('/rate-limits/tiers', requireAuth, requireRole('admin'), (_req: Request, res: Response) => {
  try {
...
router.get('/rate-limits/metrics', requireAuth, requireRole('admin'), (_req: Request, res: Response) => {
  try {
...
router.get('/rate-limits/violations', requireAuth, requireRole('admin'), (req: Request, res: Response) => {
  try {
...
router.post('/rate-limits/check', requireAuth, requireRole('admin'), async (req: Request, res: Response) => {
  try {
...
router.post('/rate-limits/reset', requireAuth, requireRole('admin'), (_req: Request, res: Response) => {
  try {
