...
export function OfflineIndicator() {
  ...
  return (
    <div className={`fixed right-4 bottom-4 left-4 z-50 rounded-lg border p-4 shadow-lg md:right-4 md:left-auto md:w-80 ${
      isOnline
      ...
      <div className="flex items-center gap-3">
        <div className="flex-shrink-0">
          {isSyncing ? (
            ...
            <svg className={`h-5 w-5 ${isOnline ? 'text-blue-600' : 'text-yellow-600'}`} fill="currentColor" viewBox="0 0 20 20">
              <path
                fillRule="evenodd"
        ...
        <div className="flex-1">
          {isSyncing ? (
            <>
              <h3 className={`text-sm font-medium ${isOnline ? 'text-blue-800' : 'text-yellow-800'}`}>
                Syncing changes...
              </h3>
