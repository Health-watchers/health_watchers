...
export default function ClinicSwitcher() {
  ...
  return (
    <div className="flex items-center gap-2" title="Switch active clinic">
      ...
      <select
        id="clinic-switcher"
        className="bg-neutral-0 max-w-[12rem] rounded-md border border-neutral-200 px-2 py-1 text-sm text-neutral-700 focus:outline-none focus:ring-2 focus:ring-primary-500 disabled:opacity-50"
        value={user?.clinicId ?? ''}
        disabled={switching}
